...
class IEPA_Blocks_Public {
  ...
  public function render_iepa_product_sale_countdown( $props ) {
    ...
    $uniqueID = isset($props['uniqueID']) ? $props['uniqueID'] : '';
		...
		echo wp_kses_post( $this->iepa_openWrap( $props, 'sale_counter_wrap'. ' iepa_sale_countdown' . $uniqueID ) );
		echo wp_kses_post( "<div class='ibtanaecommerceproductaddons-sale_counter' data-date-end='$end_date'>" );
