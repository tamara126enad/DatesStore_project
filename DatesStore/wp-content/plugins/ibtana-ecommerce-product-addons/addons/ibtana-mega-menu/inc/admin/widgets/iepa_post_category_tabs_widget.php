  ...
  class IEPA_Mega_Menu_PostCategoryLayout extends WP_Widget {
    ...
    */
    public function widget( $args, $instance ) {
      ...
      $post_category_limit          = ( isset( $instance['post_category_limit'] ) && ( $instance['post_category_limit'] != '' ) ) ? esc_attr( $instance['post_category_limit'] ) : 1;
      ...
      $filters                      = ( ! empty( $instance['filters'] ) ) ? $instance['filters'] : array(
        array(
          'label'         =>  '',
          'taxonomy'      =>  '',
          'term'          =>  '',
      ...
      <div class="iepa-pctw-wrapper">
        ...
        <div class="<?php if( $widget_layout == 'tab' ) { echo 'iepa-pctw-tabs'; } else { echo 'iepa-pctw-accordions'; } ?>">
          <?php
          $postCategories = get_terms( $post_type_cat_slug );
          foreach ( $postCategories as $key_index => $postCategory_termObj ) {
            if ( ( 1 + $key_index ) > $post_category_limit ) {
              break;
            }
            ?>
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $instance['post_category_limit']  = isset( $new_instance[ 'post_category_limit' ] ) ? sanitize_text_field( $new_instance[ 'post_category_limit' ] ) : 1;
    ...
    public function form( $instance ) {
      ...
      $post_category_limit          = isset( $instance['post_category_limit'] ) ? $instance['post_category_limit'] : 1;
      ...
      <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'post_category_limit' ) ) ?>">
          <?php esc_html_e( 'Category Tabs Limit: ', IEPA_TEXT_DOMAIN ); ?>
        </label>
        <input type="number" name="<?php echo esc_attr( $this->get_field_name( 'post_category_limit' ) ) ?>"
          value="<?php echo esc_attr( $post_category_limit ); ?>"
          id="<?php echo esc_attr( $this->get_field_id( 'post_category_limit' ) ) ?>"
        />
      </p>
        ...
        <?php foreach ( $saved_filters as $saved_filter ): ?>
          ...
          <div class="iepa-pctl-content">
            ...
            <p>
              ...
              <?php $get_terms = get_terms( array( 'taxonomy' => 'category', 'hide_empty' => false ) ); ?>
      ...
      <a class="button iepa-pctl-add-term">
