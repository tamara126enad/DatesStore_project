...
function food_grocery_store_scripts() {	
	...
	wp_enqueue_script( 'food-grocery-store-jquery-wow', esc_url(get_template_directory_uri()) . '/assets/js/wow.js', array('jquery') );
	wp_enqueue_style( 'food-grocery-store-animate-css', esc_url(get_template_directory_uri()).'/assets/css/animate.css' );
...
function food_grocery_store_tagline_hide_show(){
	if(get_theme_mod('food_grocery_store_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
